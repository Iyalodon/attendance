import { Box, Center, Flex, Button, Avatar, Input } from "@chakra-ui/react";
    ...
    <>
      <Flex h="100vh" justifyContent={"center"}>
        <Flex alignItems={"center"} color={"white"} flexDir={"column"}>
          <Center padding={"20px"} w="100vw" bgColor={"purple"} maxW="768px">
            <Center
              fontWeight={"500"}
              flexDir={"column"}
              h="350px"
            ...
            >
              ...
              <Avatar my={1} src={userSelector.avatar_url} />
              <Flex w={"300px"}>
              <Input
                ...
                size={"lg"}
              />
              <Button w={"full"} onClick={() => inputFileRef.current.click()} color={"black"}>
                Select Avatar
              </Button>
              <Button w={"full"} onClick={uploadAvatar} color={"black"}>
                Change Avatar
              </Button>
              </Flex>
